...
export const metadata: Metadata = {
  title: "Customers — Visio Lead Gen",
  description:
    "Case studies and customer stories from South African car dealerships using Visio Lead Gen.",
};
      ...
      <section className="relative py-24">
        ...
        <div className="relative mx-auto max-w-3xl px-6">
          ...
          <p className="mt-4 text-[14px] leading-relaxed text-white/40 max-w-2xl">
            Our <Link href="/about" className="text-blue-400/80 hover:text-blue-400 underline underline-offset-4">Honesty Protocol</Link> forbids us from publishing fabricated testimonials,
          ...
          <div className="mt-10 border border-white/[0.06] bg-white/[0.02] p-6">
            <p className="font-mono text-[11px] uppercase tracking-[0.2em] text-blue-400/60 mb-3">
              In the meantime
            </p>
            <ul className="space-y-3 text-[14px] text-white/55">
              <li className="flex items-start gap-2">
                <span className="text-blue-500/40 mt-0.5">→</span>
                Read our <Link href="/research" className="text-blue-400/80 hover:text-blue-400 underline underline-offset-4">published research</Link> — 10 papers documenting methodology and thesis
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500/40 mt-0.5">→</span>
                See our <Link href="/intelligence" className="text-blue-400/80 hover:text-blue-400 underline underline-offset-4">live market intelligence</Link> — Q1 2026 data from the Visio Lead Gen platform
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500/40 mt-0.5">→</span>
                Check the <Link href="/pricing" className="text-blue-400/80 hover:text-blue-400 underline underline-offset-4">pricing</Link> and try a free trial
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500/40 mt-0.5">→</span>
