...
export default function TerminalLayout({
  ...
  return (
    <div className="min-h-screen bg-[#0a0f0d]">
      {/* Terminal Header */}
      <header className="sticky top-0 z-50 border-b border-blue-900/40 bg-[#0a0f0d]/95 backdrop-blur-sm">
        <div className="flex items-center justify-between px-4 py-2">
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              ...
              <h1 className="font-mono text-sm font-bold tracking-widest text-blue-400 uppercase">
                Visio Lead Gen Market Terminal
              </h1>
            </div>
            <span className="hidden text-xs text-blue-700 sm:inline">|</span>
            <span className="hidden font-mono text-[11px] text-blue-700 sm:inline">
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="font-mono text-[11px] tabular-nums text-blue-600">
        ...
        {/* Sub-navigation tabs */}
        <div className="flex items-center gap-1 border-t border-blue-900/20 px-4">
          {TABS.map((tab) => {
            const isActive =
