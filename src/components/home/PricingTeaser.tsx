...
const TIERS = [
  {
    ...
    price: "R1,500",
    cadence: "/mo",
    description: "For solo operators in a single vertical getting started.",
    features: [
      "25 qualified leads/mo",
      "One vertical mode",
      "WhatsApp delivery",
      "Intent scoring (0–100)",
      "Basic vertical intelligence",
      "Email support",
    ],
    cta: "Pick a Mode",
    href: "/modes",
  ...
  },
  {
    ...
    price: "R5,000",
    cadence: "/mo",
    description: "The anchor tier. Most panel customers choose this.",
    features: [
      "100 qualified leads/mo",
      "One vertical mode",
      "WhatsApp + voice delivery",
      "Full vertical intelligence",
      "All 84+ intent signals",
      "Priority routing + panel alerts",
      "Priority support",
    ],
    cta: "Pick a Mode",
    href: "/modes",
  ...
  },
  {
    ...
    price: "Custom",
    cadence: "",
    description: "For multi-vertical operators, corporates, and platform partners.",
    features: [
      "Unlimited qualified leads",
      "Multi-mode access (all 12 verticals)",
